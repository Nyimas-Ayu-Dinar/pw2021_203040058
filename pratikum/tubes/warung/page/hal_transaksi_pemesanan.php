                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools">
                                <button class="btn btn-info btn-sm pull-right" data-widget="remove"
                        ...
                        <div class="box-body">
                            <a href="?pg=pmsn&act=add"> <button type="button" class="btn btn-danger"
                                    style="background-color: #dd3974 !important;"><i class="fa fa-plus"> Tambah Data
                                    </i></button> </a>
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><?php echo "Rp. " . number_format("$r[total]", '0', '.', '.') . " " ?>
                                            </td>
                                            ...
                                            <td><a href="?pg=pmsn&act=detail&id=<?php echo $r['id'] ?>"
                                                    title="Detail Pemesanan"><button type="button"
                                                        class="btn bg-orange"><i class="fa fa-eye"></i></button></a>
                                            </td>
                                            <td><a href="?pg=pmsn&act=delete_psn&id=<?php echo $r['id'] ?>"
                                                    title="Hapus Pemesanan"><button type="button" class="btn btn-info"
                                                        onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i
            ...
            <div class="row">
                        ...
                        <div class="box-body">
                            ...
                            <form role="form" method="POST" action="">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="date" name="tgl" placeholder="MM/DD/YYY"
                                            type="text" required data-fv-notempty-message="Tidak boleh kosong" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id='id_harga' name='id_harga' class="form-control select2"
                                            onchange="changeValue(this.value)" data-validation="[NOTEMPTY]">
                          ...
                          ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="id_menu" name="id_menu" value="" type="text"
                                            disabled="" required data-fv-notempty-message="Tidak boleh kosong" />
                                        <input class="form-control" id="id_menuku" name="id_menuku" value=""
                                            type="hidden" required data-fv-notempty-message="Tidak boleh kosong" />
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Harga Per Satuan</label>
                                        <input class="form-control" id="hargaku" name="hargaku" value="" type="text"
                                            disabled="" required data-fv-notempty-message="Tidak boleh kosong" />
                                        <input class="form-control" id="harga" name="harga" value="" type="hidden"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="jumlah" name="jumlah"
                                            onchange="total(this.value)" type="text" required
                                            data-fv-notempty-message="Tidak boleh kosong" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <!-- <input class="form-control" id="total" name="total" type="text" required data-fv-notempty-message="Tidak boleh kosong"/> -->
                                                <h3> <b>
                                                        <div id="hasil"> <input class="form-control" id="total"
                                                                name="total" type="text" /></div>
                                                    </b></h3>
                                            </div>
                                        </div>
              ...
              <input onclick="proses()" type="button" value="Tampilkan"/> -->
                                    ...
                                    function changeValue(id_harga) {
                                        var hargaku = document.getElementById('hargaku').value = HargaSatuan[id_harga]
                                            .harga;
                                        var harga = document.getElementById('harga').value = HargaSatuan[id_harga]
                                            .harga;
                                        var id_menuku = document.getElementById('id_menuku').value = HargaSatuan[
                                            id_harga].menu;
                                        var id_menu = document.getElementById('id_menu').value = HargaSatuan[id_harga]
                                            .menu;
            ...
            <form role="form" method="POST" action="">
              ...
              ?>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kd_transaksi" value="<?php echo $kd_trans; ?>"
                            name="kd_transaksi" required data-fv-notempty-message="Tidak boleh kosong" disabled>
                        <input type="hidden" class="form-control" id="kd_transaksi" value="<?php echo $kd_trans; ?>"
                            name="kd_transaksi" required data-fv-notempty-message="Tidak boleh kosong">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">No Meja</label><input class="form-control" id="no_meja"
                            name="no_meja" value="" type="text" required
                            data-fv-notempty-message="Tidak boleh kosong" />
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Atas Nama</label><input class="form-control" id="atas_nama"
                            name="atas_nama" value="" type="text" required
                            data-fv-notempty-message="Tidak boleh kosong" />
                    </div>
                    <!-- Select2 Single Item -->
                    <div class="table-responsive">
                   ...
                   order by a.tgl asc");
                    ...
                    ?>
                                <tr>
                                    <td><?php echo "$no" ?></td>
                                    <td><input type="hidden" name="id_menu[]" value='<?php echo "$r[id_menu]" ?>' />
                                        <?php echo "$r[nama_menu]" ?></td>
                                    <td><input type="hidden" name="harga[]"
                                            value='<?php echo "$r[harga]" ?>' /><?php echo "Rp. " . number_format("$r[harga]", '0', '.', '.') . " " ?>
                                    </td>
                                    <td><input type="hidden" name="jumlah[]" value='<?php echo "$r[jumlah]" ?>' />
                                        <?php echo "<b>$r[jumlah]</b>" ?></td>
                                    <td><a href="?pg=pmsn&act=delete&id=<?php echo $r['id_trans'] ?>"><button
                    ...
                    ?>
                                ...
                                <td><span style="font-weight:bold"><input type="hidden" name="total"
                                            value='<?php echo "$liatHarga[subtotal]" ?>' />
                                        <?php echo "Rp." . number_format("$liatHarga[subtotal]", '0', '.', '.') ?></td>
                    ...
                    <div class="box box-success">
                        <div class="box-body">
                          ...
                          ?>
                                            ...
                                            <tr>
                                                <td><?php echo "$no" ?></td>
                                                <td><input type="hidden" name="id_menu"
