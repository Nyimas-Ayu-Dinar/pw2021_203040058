...
<table border='0' align='LEFT'>
    <tr>
        ...
        <th width="900px" align="left">
            <h2>
                <left> LAPORAN PEMESANAN MENU MAKANAN AYU<br> </left>
...
<br>
<h3 style="text-align:center;"> LAPORAN PEMESANAN MENU MAKANAN AYU </h3>
    ...
    <tbody>
     ...
     order by a.kd_transaksi asc");
        ...
        <tr>
            ...
            <td><span
                    style="font-weight:bold"><?php echo "Rp." . number_format("$liatHarga[total_pemesanan]", '0', '.', '.') ?>
            </td>
