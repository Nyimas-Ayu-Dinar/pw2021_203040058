...
<table border='0' align='LEFT'>
    <tr>
        ...
        <th width="900px" align="left">
            <h2>
                <left> LAPORAN PEMBAYARAN MENU MAKANAN AYU<br> </left>
...
<br>
<h3 style="text-align:center;"> LAPORAN PEMBAYARAN MENU MAKANAN AYU </h3>
...
<table cellspacing="0" cellpadding="5" border="1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span
                    style="font-weight:bold"><?php echo "Rp." . number_format("$liatHarga[total_pembayaran]", '0', '.', '.') ?>
            </td>
