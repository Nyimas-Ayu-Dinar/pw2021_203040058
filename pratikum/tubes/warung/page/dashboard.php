                ...
                <div class="col-md-12">
                  ...
                  ?>
                                    ...
                                    <div class="small-box bg-aqua">
                                        ...
                                        <a href="?pg=menu&act=view" class="small-box-footer">More info <i
                  ...
                  ?>
                                    ...
                                    <div class="small-box bg-green">
                                        ...
                                        <a href="?pg=pmsn&act=view" class="small-box-footer">More info <i
                                                class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div><!-- ./col -->
                                <div class="col-lg-3 col-xs-6">
            ...
            <div class="row">
                ...
                <section class="col-md-12 connectedSortable">
                    <div class="callout callout-danger" style="background-color: #red !important;">
                        ...
                        <p>DI APLIKASI PEMESANAN MAKANAN RUMAH MAKAN AYU</p>
                    </div>
