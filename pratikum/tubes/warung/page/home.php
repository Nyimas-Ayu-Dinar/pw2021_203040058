...
<head>
    ...
    <title>APLIKASI PEMESANAN MENU MAKANAN | RUMAH MAKAN AYU</title>
...
<body class="hold-transition skin-red-light layout-boxed layout-top-nav ">
    <div class="wrapper">
        ...
        <header class="main-header">
            <nav class="navbar navbar-static-top">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="/">RUMAH MAKAN AYU <span class="sr-only">(current)</span></a>
                            </li>
                            <!-- <li><a href="#">Link</a></li> -->
                            <?php
              ...
              ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Master Data <span
                                        class="caret"></span></a>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Data Transaksi <span
                                        class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="?pg=pmsn&act=view"><i class="fa fa-check-square-o"></i> Transaksi
                                            Pemesanan Menu</a></li>
                                    <li class="divider"></li>
                                    <li><a href="?pg=pmby&act=view"><i class="fa fa-check-square-o"></i> Transaksi
                                            Pembayaran Menu</a></li>
                                    <li class="divider"></li>
                    ...
                    <li><a href="?pg=pmbln&act=view"><i class="fa fa-check-square-o"></i> Transaksi Pembelian Menu</a></li> -->
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li class="divider"></li>
                                    <li><a href="?pg=lap_pemesanan&act=view"><i class="fa fa-check-square-o"></i>
                                            Laporan Pemesanan</a></li>
                                    <li class="divider"></li>
                                    <li><a href="?pg=lap_pembayaran&act=view"><i class="fa fa-check-square-o"></i>
    ...
    ?>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2021 <a href="#">RUMAH MAKAN AYU</a>.</strong>
        </footer>
