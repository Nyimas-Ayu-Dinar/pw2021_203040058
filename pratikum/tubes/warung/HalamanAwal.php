        ...
        <section class="content">
            <div class="row">
                ...
                <div class="form-group">
                            ...
                            <h2 class="page-header">Silahkan Pilih Makanan dan Minumannya ya kamuu</h2>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="box box-widget widget-user" style="height: 230px">
                                                ...
                                                <div class="widget-user-header bg-black"
                                                    style="background: url('<?php echo "upload/menu/" . $r['gambar'] . " "; ?>') center center;">
                      ...
                      <img class="img-circle" src="dist/img/photo1.png" alt="User Avatar">
                                                ...
                                                <div class="box-footer">
                                                    <div class="row">
                                                        <div class="col-sm-8 border-right">
                                                            <div class="description-block">
                                                                <h6 class="description-header">
                                                                    ...
                                                                    <input type="hidden" name="id_harga"
                                                                        value="<?php echo $r['id_harga'] ?>">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="description-block">
                                                                <button type="submit" name='add_temp'
                                                                    class="btn btn-primary btn-block btn-flat"
                                                                    style="border-radius: 5px;padding-left: 5px;"> Pilih
                                                                </button>
                                                                <?php
                                  ...
                                  ?>
                                                                <button type="submit" name=''
                                                                    class="btn btn-primary btn-block btn-flat"
                                                                    style="background-color: #dd3974 !important;border-radius: 5px;padding-left: 3px;">
                                                                    Habis </button>
                                                                <?php
                                  } else {
                                  ?>
                                                                <button type="submit" name=''
                                                                    class="btn btn-primary btn-block btn-flat"
                                                                    style="background-color: #dd3974 !important;border-radius: 5px; ">
                                                                    <?php echo $r['sisa'] ?> </button>
                                                                <?php } ?>
                                                            </div><!-- /.description-block -->
                                                        </div><!-- /.col -->
                                                    </div><!-- /.row -->
                ...
                <div class="col-md-4">
                    ...
                    ?>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="usr_transaksi"
                                                value="<?php echo strtoupper($_SESSION['username']); ?>"
                                                name="usr_transaksi" disabled>
                                            <input type="hidden" class="form-control" id="usr_transaksi"
                                                value="<?php echo strtoupper($_SESSION['username']); ?>"
                                                name="usr_transaksi">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kd_transaksi"
                                                value="<?php echo $kd_trans; ?>" name="kd_transaksi" disabled>
                                            <input type="hidden" class="form-control" id="kd_transaksi"
                                                value="<?php echo $kd_trans; ?>" name="kd_transaksi">
                                        </div>

                                        <div class="form-group">
                                            <input class="form-control" id="no_meja" name="no_meja" value=""
                   ...
                   order by a.tgl asc");
                          ...
                          ?>
                                                    <tr>
                                                        <!-- <td><?php echo "$no" ?></td> -->
                                                        <td><a
                                                                href="?pelanggan.php&act=delete&id=<?php echo $r['id_trans'] ?>"><button
                                                                    type="button" class="btn btn-info"
                                                                    onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i
                                                                        class="fa fa-trash-o"></i></button></a></td>
                                                        <td colspan="2"><input type="hidden" name="id_menu[]"
                                                                value='<?php echo "$r[id_menu]" ?>' />
                                                            <?php echo "$r[nama_menu]" ?></td>
                                                        <td><input type="number" name="jumlah[]"
                                                                value='<?php echo "$r[jumlah]" ?>' style="width:80px" />
                                                            <!-- <?php echo "<b>$r[jumlah]</b>" ?> -->
                                                        </td>
                                                        <td><input type="hidden" name="harga[]"
                                                                value='<?php echo "$r[harga]" ?>' /><?php echo $r['harga'] ?>
                    ...
                    ORDER BY id ASC"));
                          ?>
                                                    ...
                                                    <td><span style="font-weight:bold"><input type="hidden" name="total"
                                                            ...
                                                            <?php echo "Rp." . number_format("$liatHarga[subtotal]", '0', '.', '.') ?>
                                                    </td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <button type="submit" name='add' class="btn btn-danger">Simpan
                                                    Pesanan</button>
                                                &nbsp;
                                                <button type="submit" name='update_pesanan'
                                                    class="btn btn-success">Update Pesanan</button>
